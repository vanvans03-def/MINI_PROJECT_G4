...
<body>
                            ...
                            <div class="row  justify-content-center ">
                                ...
                                <div class="card  border-0 col-md-auto" style="width: 50%;">
                                    <div class="d-flex justify-content-center">
                                        <img src="http://127.0.0.1/Mini_Project_G4/images/TV/apple_tv_4k_logo__vyjj7uki3tui_medium.png" style="width: 10rem;" class="" alt="...">
                                    </div>
                                    <h4 class="text-center fw-bold display-1 mb-5" style="font-size: 30px;">
                                        ...
                                        <span class="text-center" style="font-size: 25px;">เริ่มต้นที่ ฿6,700&nbsp;<a class="btn btn-primary fs-4 rounded-pill" style="width:70px;" href="tv-shop.php" role="button">ซื้อ</a><br>
                                            <img src="http://127.0.0.1/Mini_Project_G4/images/TV/higher_definition__hfivribdc3ue_large.jpg" style="width: 100%" class="card-img-center" alt="...">
                                ...
                                <div class="card  border-0 col-md-auto">
                                    <div class="d-flex justify-content-center">
                                        <img src="http://127.0.0.1/Mini_Project_G4/images/TV/home_icon__9u57pp0qahea_medium.png" style="width: 5rem;" class="card-img-center:auto;" alt="...">
                                    </div>
                                    <h4 class="text-center fw-bold display-1 mb-5" style="font-size: 30px;">บ้าน<br>
                                        <span class="text-center" style="font-size: 25px;">บ้านของคุณภายใต้บังคับบัญชาของคุณ<br>
                                        </span>
                                    </h4>

                                    <img src="http://127.0.0.1/Mini_Project_G4/images/TV/your_home_at_your_command__b1w2tomy2wia_large.jpg" style="width: 100%;padding-left: 10rem;">
    ...
    <video width="100%" height="100%" controls="controls" muted="" playsinline="" autoplay="" loop="" data-inline-media="" data-inline-media-plugins="ViewportSource, PlayPauseButton" preload="none" role="presentation">
