                    ...
                    <div class="d-flex justify-content-center ">
                        ...
                        <form action="login_db.php" method="post">
                            ...
                            <div class="form-group" style="width: 350px; ">
                                ...
                                <input style="height: auto;" type="email" class="form-control fs-3" name="email" id="email" aria-describedby="emailHelp" placeholder="AppleID"><br>
                            ...
                            <br>
                            <button type="submit" name="login_user" class="btn btn-primary "><span class="fs-3 ">Login</span></button><br>
                            <div class="col">
                                <a class=" cta-link fs-4 mb-3" href="#"><br> ลืม Apple ID หรือรหัสผ่านหรือไม่? </a>
