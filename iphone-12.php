...
<head>
    ...
    <title>ซื้อ iPhone 12 - Apple (TH)</title>
        ...
        <div class="my-container ">
            ...
            <div class="row justify-content-md-left">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <h4 class="text-center fs-1 fw-bold display-1 mb-5">iPhone 12 </h4>
                        </div>
                        <div class="col">
                            &nbsp;
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card  border-0">
                            <img id="iphone13-shop" src="http://127.0.0.1/Mini_Project_G4/images/shop/iphone12/iphone-12-select-2021.jpg" alt="" class="card-img-top">
                            <div class="card-body">
                                ...
                                ?>
                                    <form action="shopping_db.php" class="" method="post" enctype="multipart/form-data">
                                        ...
                                        <label class="btn btn-outline-secondary col-12 border border-2 rounded-3" for="iphone12" style="height: 80px;">
                                            <div class="row" style="padding-top: 10px;">
                                                <div class="col">
                                                    <p class="fs-5 display-1 fw-bold fs-2 mb-2 textcard">iPhone 12 
                                                    </p>
                                ...
                                <div class="d-grid gap-2 d-md-block">
                                    <input type="radio" class="btn-check" id="colorgreen"  autocomplete="off" name="color" value="9">
                                        <label class="btn btn-outline" for="colorgreen" >
                                            <img src="http://127.0.0.1/Mini_Project_G4/images/shop/color/finish-green-202010.jpg" alt="" style="width: 7rem;" onclick="document.getElementById('iphone13-shop').src='http://127.0.0.1/Mini_Project_G4/images/shop/iphone12/iphone-12-green-select-2020.png';">
                                        </label>
                                </div>
