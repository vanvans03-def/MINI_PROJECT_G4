                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card  border-0">
                            <img id="iphone13-shop" src="http://127.0.0.1/Mini_Project_G4/images/shop/iphone-13-pro-family-hero.png" alt="" class="card-img-top">
                            <div class="card-body">
                    ...
                    <div class="col-sm-6 shop-bg">
                        <div class="card shop-bg border-0">
                            <div class="card-body shop-bg">
                                ...
                                ?>
                                    <form action="shopping_db.php" class="" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="radio" class="btn-check" id="iphone13pro"  autocomplete="off" name='product_name' value="iphone 13 Pro">
                                        ...
                                        <p>&nbsp;</p>
                                        <input type="radio" class="btn-check" id="iphone13promax" autocomplete="off" name='product_name' value="iPhone 13 Pro Max">
                            ...
                            <div class="container2x2 ">
                                ...
                                <div class="d-grid gap-2 d-md-block">
                                    <input type="radio" class="btn-check" id="colorblue"  autocomplete="off" name="color" value="สีเชียร์ร่าบลู">
                                ...
                                <div class="d-grid gap-2 d-md-block">
                                    <input type="radio" class="btn-check" id="colorgold"  autocomplete="off" name="color" value="สีทอง">
                                ...
                                <p class="underline" style="padding-top:70px;"></p> </br>
                                <!--end of color choice-->
                                <p class="text-left fs-2 fw-bold display-2 mb-2">
                                    <span class="text-black">
                                        เลือกความจุ</span>
