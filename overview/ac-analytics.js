require = (function() {
            ...
            var u = [].concat(p(n.KEYS.PATHS.CONFIG), ["global", "cookieDomain"]),
                ...
                f = e.pipe(
                    function() {
                        ...
                        return (
                            e.cookieJson.set("mk_epub", null, l({}, a, { domain: b() })), n
                        );
                    },
                    function(t) {
                        var r = n.get(o);
                        !e.beaconHelpers.isNotEmpty(t) ||
                            (e.beaconHelpers.isNotEmpty(r) && t.btuid === r.btuid) ||
                            n.set(o, t),
                            n.remove([].concat(p(o), ["btuid"]));
                    }
                ),
                m = e.pipe(
                    function(n) {
                        return e.beaconHelpers.isNotEmpty(n) ?
                        ...
                        return e.beaconHelpers.isNotEmpty(n) ?
                            i.reduce(
                                function(t, r) {
                                    ...
                                    return c && a + s <= 500 ?
                                        ((o[i] = c), { beacon: o, beaconLength: a + s }) : { beacon: o, beaconLength: a };
                ...
                y = e.pipe(
                    ...
                    m,
                    function(n) {
                        e.beaconHelpers.isNotEmpty(n) &&
                            e.cookieJson.set("mk_epub", n, l({}, a, { domain: b() }));
                    }
                );
        ...
        function(require, module, exports) {
            ...
            var c = function() {
                ...
                o = (function(e) {
                    ...
                    c({ keyPrefix: "PROP_", valuePrefix: "prop", count: 75 }), {},
                    c({ keyPrefix: "EVAR_", valuePrefix: "eVar", count: 155 })
                ),
                i = c({ keyPrefix: "EVENT_", valuePrefix: "event", count: 520 });
            ...
            var s = function() {
                    var e =
                        ...
                        r = p({}, e);
                    return (
                        e.hasOwnProperty(o.EVENTS) &&
                        (r[o.EVENTS] = t.parseEventCollectionString(e[o.EVENTS])),
                        e.hasOwnProperty(o.PRODUCTS) &&
                        (r[o.PRODUCTS] = t.parseProductCollectionString(e[o.PRODUCTS])),
                        r
                    );
                },
                f = [
                    function() {
                        var r =
                            ...
                            a = r.previous,
                            o = void 0 === a ? {} : a;
                        return e.merge({ target: s(o.beacon), source: s(n.beacon) });
                    },
                    function() {
                        var e =
                            arguments.length > 0 && void 0 !== arguments[0] ?
                ...
                v = { pageLoad: "page", userInteraction: "next" },
                O = function(t) {
                    var n = t.type,
                        a = t.globalTracking,
                        o = t.element;
                    if (!Object.keys(v).includes(n) ||
                        (a &&
                            (function(e) {
                                if (!o) return !1;
                                var r = o.closest("a");
            ...
            (O.label = "analytics-bp-passive-tracker-loader"),
            (exports.passiveTrackerLoader = O);
        },
        {
    ...
    4: [
        function(require, module, exports) {
            ...
            Object.defineProperty(exports, "__esModule", { value: !0 });
            var e,
                t = require("@apple/analytics-data-layer-keys"),
                ...
                n = function() {
                    return (
                        (Number(r.localStorage.get("mk_epub_expiry")) || 0) < Date.now()
                    );
                },
                s = function() {
                    clearTimeout(e),
                        (function t(o) {
                            (!o && n()) ||
                            (r.localStorage.set("mk_epub_expiry", Date.now() + 72e5),
                                (e = setTimeout(t, 3e5)));
                        })(!0);
                };
            ...
            var u = function(e) {
                ...
                g = function() {
                    ...
                    l.persisted &&
                        ((e = p([l.persisted.key])) &&
                            ...
                            (s(), r.localStorageJson.set("mk_epub", e)) :
                            o());
                },
                S = function() {
                ...
                d = function() {
                    l.sessionStore &&
                        y(
                            [l.sessionStore.key],
                            r.sessionStorageJson.get("mk_epub") || (S(), {})
                        );
                },
                v = function() {
                    var e;
                    l.sessionStore &&
                        ((e = p([l.sessionStore.key])) &&
                            "object" === i(e) &&
                            Object.keys(e).length ?
                            r.sessionStorageJson.set("mk_epub", e) :
                            S());
                },
                j = function(e, t) {
                    ...
                    (function() {
                        if (l.meta) {
                            for (
                                ...
                                i[a[u].getAttribute(o).replace(n, "")] =
                                a[u].getAttribute(s);
                            j(t, i);
                        }
                    })(),
        ...
        function(require, module, exports) {
            ...
            (exports.merge = function(r) {
                var t = r.target,
                    ...
                    i = void 0 === c ? {} : c;
                return (
                    "string" == typeof n.events &&
                    (n.events = e.parseEventCollectionString(n.events)),
                ...
                return (
                    ...
                    (function(t, e) {
                        if (
                            ...
                            try {
                                for (
                                    var u, a = t[Symbol.iterator](); !(n = (u = a.next()).done) &&
                                    (r.push(u.value), !e || r.length !== e); n = !0
                                );
                            } catch (t) {
                                (i = !0), (o = t);
                            } finally {
            ...
            var g = function(t) {
                ...
                S = function() {
                    ...
                    return e
                        .reduce(function(t, e) {
                            return (
                                e instanceof j ? t.push.apply(t, b(e.values())) : t.push(e), t
                            );
                        }, [])
                        .filter(function(t) {
                        ...
                        i(e, [{
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    var t = this;
                                    return (
                                        S.apply(void 0, arguments).forEach(function(e) {
                                            if (e instanceof m) {
                                                var r = t.get(e.key);
                                                r ? r.merge(e) : t.add(e);
                                            }
                ...
                E = (function(e) {
                    function n(t, e) {
                        var i;
                        return (
                            r(this, n), ((i = h(this, s(n).call(this, t))).value = e), i
                        );
                    }
                    return (
                        c(n, m),
                ...
                P = (function(e) {
                    function n() {
                        ...
                        return (
                            (o.sku = t.beaconHelpers.guessPartNumber(o.sku)),
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    return [
                                            ...
                                            this.events ? this.events.toString(w) : "",
                                            this.variables ? this.variables.toString(O) : "",
                                        ]
                                        .join(k)
                                        .replace(",", "");
                                },
            ...
            var t = function() {
                ...
                n = (function(t) {
                    for (var n = 1; n < arguments.length; n++) {
                        ...
                        n % 2 ?
                            r(Object(c), !0).forEach(function(r) {
                                e(t, r, c[r]);
                            }) :
                            Object.getOwnPropertyDescriptors ?
                            Object.defineProperties(
                    ...
                    t({ keyPrefix: "PROP_", valuePrefix: "prop", count: 75 }), {},
                    t({ keyPrefix: "EVAR_", valuePrefix: "eVar", count: 155 })
                ),
                c = t({ keyPrefix: "EVENT_", valuePrefix: "event", count: 520 });
            (c.SC_ADD = "scAdd"),
                ...
                return (
                    ...
                    (function(e, t) {
                        if (
                            ...
                            try {
                                for (
                                    var i, c = e[Symbol.iterator](); !(n = (i = c.next()).done) &&
                                    (r.push(i.value), !t || r.length !== t); n = !0
                                );
                            } catch (e) {
                                (o = !0), (a = e);
                            } finally {
            ...
            var l = function(e) {
                ...
                I = function(e) {
                    var t = e.value,
                        r = e.api,
                        n = void 0 === r ? O : r;
                    D({ api: n, key: "sync", value: t }), x({ api: n, key: "sync" });
                },
                V = function() {
                    var e = (
                            arguments.length > 0 && void 0 !== arguments[0] ?
                        ...
                        t = void 0 === e ? O : e;
                    D({ api: t, key: "clearAll", value: "sync-clear-all" }),
                        x({ api: t, key: "clearAll" });
                },
                C = function(e) {
                    var t =
                        arguments.length > 1 && void 0 !== arguments[1] ?
                    ...
                    switch (e.destination) {
                        ...
                        default:
                            P({
                                ...
                                e.transformedSync &&
                                "" !== e.transformedSync &&
                                I({ api: t, value: e.transformedSync });
                    }
                ...
                R = function(e) {
                    ...
                    switch (!0) {
                        case !i(r) && i(n):
                            a = re({ schema: t, data: n });
                            break;
                        case i(r) && !i(n):
                            a = re({ schema: t, data: r });
                            break;
                        case u && f:
                            a = o(
                                o({}, re({ schema: t, data: n })),
                                re({ schema: t, data: r })
                            );
                            break;
                        case u && !f && l:
                            var d = re({ schema: t, data: n });
                            t.data
                                .filter(function(e) {
                                    return !e.syncTabs;
                                })
                                ...
                                (a = o(o({}, d), re({ schema: t, data: r })));
                            break;
                        case u && !l:
                            a = o({}, re({ schema: t, data: r }));
                    }
                    return a;
                },
                U = function() {
                    ...
                    if (t.allSchemas) {
                        for (
                            ...
                            var a = r[o],
                                ...
                                l = E({ api: e, key: s }),
                                f = T({ api: e, key: u }),
                                p = R({ schema: i, cookieData: l, sessionData: f });
                ...
                G = function(e, t) {
                    Object.keys(t).forEach(function(r) {
                        var n = t[r],
                            o = e.data[r],
                            a = z(e, r);
                        e.data[r] = q({ storedValue: n, newValue: o, mergePolicy: a });
                    });
                },
                J = function(e) {
                    e.data.uuid = d();
                ...
                te = function() {
                    ...
                    return (
                        (e.options = o(
                            o({}, { origin: "same", version: "v1", minor: "1" }),
                            e.options
                        )),
                        e
                    );
                ...
                ae = function() {
                    !(function() {
                        var e = (
                            ...
                            t = void 0 === e ? O : e;
                        D({ api: t, key: "onNewPage", value: "handle-new-page-save" }),
                            x({ api: t, key: "onNewPage" });
                    })();
                    var e = (function(e) {
                            var t = e.schema,
                                r = e.api,
                                    ...
                                    case "sync":
                                        if (e.newValue) {
                                            var s = T({ api: n, key: r }),
                                                u = e.newValue;
                                            if (s) {
                                                var l = re({ schema: t, data: s }),
                                                    f = re({ schema: t, data: e.newValue }),
                                                    d = p(l.uuid),
                                                    y = p(f.uuid),
            ...
            var cookieDomain = null,
                ...
                syncToCookie = function() {
                    var e = _objectSpread2(
                            _objectSpread2({}, { version: MULE_VERSION }), {}, { origin: "cross" }
                        ),
                        t = getCookieDomain();
        ...
        function(require, module, exports) {
                ...
                return (
                    ...
                    (function(t, n) {
                        if (
                            ...
                            try {
                                for (
                                    var i, u = t[Symbol.iterator](); !(r = (i = u.next()).done) &&
                                    (e.push(i.value), !n || e.length !== n); r = !0
                                );
                            } catch (t) {
                                (o = !0), (c = t);
                            } finally {
            ...
            (exports.getBeacon = function(n) {
                ...
                return (
                    ...
                    e.forEach(function(n) {
                        t(n) &&
                            (c[n] ?
                                ((u.events = s(u.events, n)),
                                    (u.eVar17 = l(u.eVar17, c[n]))) :
                                o &&
                                o[n] &&
                                ((u.events = s(u.events, n)),
            ...
            (exports.relayRead = function() {
                ...
                return (
                    ...
                    }), { queryString: a.toString(), beacon: v }
                );
            }),
            (exports.relayWrite = function() {
                var t =
                    ...
                    c = f(e).get("rid");
                return (
                    c && (o[c.slice(0, 3)] = encodeURIComponent(c.slice(4))), a(o)
                );
            });
        },
        {},
        ...
        function(require, module, exports) {
            ...
            var c = {
                ...
                l = function(t) {
                    var n = t.accessoriesLink,
                        ...
                        a = new e.OmnitureCollection(
                            new e.OmnitureEvent(E ? c.COMPLETE : c.SEARCH)
                        );
                    return (
                        0 === i && a.add(new e.OmnitureEvent(c.NO_RESULTS_CLICK)),
                ...
                V = function(t) {
                    ...
                    return (
                        n || (n = i ? E || "aos_search_result" : ""), { eVar17: n, events: c }
                    );
                },
                u = function(t) {
            ...
            (exports.accessoriesFilter = function() {
                var r,
                    ...
                    S = i.analyticsPrefix;
                return (
                    o((r = {}), t.VARS.EVAR_2, n.toStrTrim(E).toLowerCase()),
                    o(
                        r,
                        t.VARS.EVAR_4,
                    ...
                    o(r, t.VARS.PROP_7, n.toStrTrim(E).toLowerCase()),
                    o(
                        r,
                        t.VARS.EVENTS,
            ...
            (exports.begin = function() {
                ...
                return (
                    o(
                        (r = {}),
                        t.VARS.PROP_3,
                        "".concat(n.toStrTrim(E) || "engage", " - search field")
                    ),
                    o(
                        r,
                        t.VARS.EVENTS,
            ...
            (exports.exit = function() {
                ...
                return (
                    o((r = {}), t.VARS.PROP_7, n.toStrTrim(i).toLowerCase()),
            ...
            (exports.pagination = function() {
                ...
                return (
                    o(
                        (r = {}),
                        t.VARS.PROP_2,
                        "".concat(n.toStrTrim(S), " - page ").concat(n.toStrTrim(E))
                    ),
                    o(
                        r,
                        t.VARS.PROP_3,
            ...
            (exports.perform = function() {
                ...
                return E({},
                    void 0 !== V ?
                    o({},
                        t.VARS.EVAR_23, [O, N, d, u, V].map(n.toStrTrim).join("|")
                    ) : {},
                    (o(
                            (r = {}),
                            t.VARS.PROP_7,
            ...
            (exports.resultClick = function() {
                var e,
                    ...
                    (o((e = {}), t.VARS.PROP_7, m),
                        ...
                        e);
                return (
                    A.eVar17 && (g[t.VARS.EVAR_17] = A.eVar17), !a && v && (g[t.VARS.PROP_29] = u([m, S, O, N, T])),
            ...
            (exports.serpPageLoad = function() {
                ...
                return E({},
                    (o(
                        ...
                        o(r, t.VARS.PROP_21, n.toStrTrim(u) || "0"),
                        r),
                    S ?
                    (o((i = {}), t.VARS.EVAR_2, "D=c7"),
                        o(
                            i,
                            t.VARS.EVAR_15,
                        ...
                        i) :
                    (o((a = {}), t.VARS.EVAR_15, "|".concat(n.toStrTrim(V))),
                        o(a, t.VARS.EVENTS, _),
                        a)
                );
            });
        ...
        function(require, module, exports) {
            ...
            var e = require("@apple/analytics-omniture-constants"),
                ...
                v = function(e) {
                    ...
                    for (
                        var t = (document.cookie || "").split(";"), r = 0; r < t.length; r++
                    ) {
                        var n = (t[r] || "").trim();
                ...
                d = Object.freeze({ __proto__: null, get: v, set: y });
                ...
                return (
                    ...
                    (function(e, t) {
                        if (
                            ...
                            try {
                                for (
                                    var u, a = e[Symbol.iterator](); !(n = (u = a.next()).done) &&
                                    (r.push(u.value), !t || r.length !== t); n = !0
                                );
                            } catch (e) {
                                (o = !0), (i = e);
                            } finally {
            ...
            var x = function() {
                ...
                A = Object.freeze({ __proto__: null, get: S, set: k }),
                P = function(e) {
                    if (!e) return null;
                    try {
                        return JSON.parse(e);
                ...
                E = Object.freeze({ __proto__: null, decode: P, encode: L }),
                I = c(S, P),
                z = Object.freeze({
                    __proto__: null,
                    get: I,
                ...
                X = Object.freeze({
                    ...
                    getPartNumber: function() {
                        var e =
                            ...
                            n = e.parent,
                            o = void 0 === n ? null : n,
                            i = F({ element: r, parent: o });
                        return i || H({ element: r, parent: o }) || null;
                    },
                }),
                J = c(v, P),
                V = Object.freeze({
                ...
                G = Object.freeze({
                    ...
                    debounce: function(e) {
                        ...
                        return function() {
                            for (
                                var n = arguments.length, o = new Array(n), i = 0; i < n; i++
                            )
                                o[i] = arguments[i];
                            clearTimeout(r),
                ...
                Y = Object.freeze({ __proto__: null, get: Q, set: Z, remove: $ }),
                ee = c(Q, P),
                te = Object.freeze({
                    __proto__: null,
                    get: ee,
                ...
                ae = Object.freeze({
                    ...
                    formatPath: function e() {
                        for (
                            var r = arguments.length, n = new Array(r), o = 0; o < r; o++
                        )
                            n[o] = arguments[o];
                        return n
                            .map(function(r) {
                ...
                pe = Object.freeze({ __proto__: null, get: le, set: se, remove: fe }),
                ge = c(le, P),
                ve = Object.freeze({
                    __proto__: null,
                    get: ge,
                ...
                me = function(e) {
                    for (
                        var t = arguments.length, r = new Array(t > 1 ? t - 1 : 0), n = 1; n < t; n++
                    )
                        r[n - 1] = arguments[n];
                    return (
                ...
                we = Object.freeze({
                    ...
                    isServiceSERPLink: function(e) {
                        return (
                            de(e) &&
                            (be({ element: e, property: "protocol", values: he }) ||
                                be({ element: e, property: "hostname", values: _e }))
                        );
                    },
                    ...
                    isTargetingOtherWindow: function(e, t) {
                        ...
                        return (
                            t.metaKey ||
                            t.ctrlKey ||
                            t.shiftKey || ["", "_self", "_parent", "_top"].every(function(e) {
                                return e !== r;
                            }) ||
            ...
            (exports.asCookie = A),
            (exports.asCookieJson = z),
            (exports.beaconHelpers = X),
            (exports.cookie = d),
            (exports.cookieJson = V),
            ...
            (exports.jsonEncoder = E),
            (exports.localStorage = Y),
            (exports.localStorageJson = te),
            (exports.objectHelpers = ce),
            (exports.objectPath = ae),
            (exports.pipe = c),
            (exports.sessionStorage = pe),
            (exports.sessionStorageJson = ve),
            (exports.stringHelpers = a),
            (exports.toStr = t),
            (exports.toStrTrim = r),
            (exports.urlHelpers = we);
        },
        { "@apple/analytics-omniture-constants": 8 },
    ],
    13: [
    ...
    23: [
        function(require, module, exports) {
            ...
            module.exports = function(e) {
                ...
                if (e)
                    for (
                        (t = document.createElement("div")).innerHTML = e; t.firstChild;
        ...
        function(require, module, exports) {
            ...
            module.exports = {
                ...
                insertNode: function(E, N, e, _) {
                    if (
                        ((_ = _ || "node"), (E || N) && !isNodeType(E, VALID_INSERT_NODE))
                    )
    ...
    40: [
        ...
        { "./DOCUMENT_FRAGMENT_NODE": 34, "./internal/isNodeType": 38 },
    ],
    41: [
        function(require, module, exports) {
            "use strict";
        ...
        { "./ELEMENT_NODE": 36, "./internal/isNodeType": 38 },
    ],
    42: [
        function(require, module, exports) {
            "use strict";
    ...
    44: [
        function(require, module, exports) {
            ...
            module.exports = function(e, t, r, a) {
                if (
                    (validate.childNode(e, !0, "ancestors"),
    ...
    48: [
        function(require, module, exports) {
            ...
            module.exports = function(e, t) {
                return (
                    validate.selector(t, !0, "matchesSelector"), !!isElement(e) &&
                    (nativeMatches ?
                        nativeMatches.call(e, t) :
                        matchesSelectorShim(e, t))
                );
            };
        },
        {
        ...
        function(require, module, exports) {
            ...
            module.exports = function(e, l) {
                return (
                    ...
                    querySelectorAllAvailable ?
                    Array.prototype.slice.call(l.querySelectorAll(e)) :
                    querySelectorAllShim(e, l)
                );
            };
        },
        {
        ...
        function(require, module, exports) {
            ...
            module.exports = function(e, t) {
                ...
                for (
                    ...
                    (n = document[c].shift()).style.removeAttribute("ac-qsa"), -1 === o.indexOf(n) && isElementInContext(n, t) && o.push(n);
    ...
    53: [
        function(require, module, exports) {
            ...
            (proto._ifInView = function(e, t) {
                var i = e.inThreshold;
                Super.prototype._ifInView.apply(this, arguments), !i &&
    ...
    56: [
        ...
        { "./ELEMENT_NODE": 54, "./internal/isNodeType": 55 },
    ],
    57: [
        function(require, module, exports) {
            "use strict";
    ...
    60: [
        function(require, module, exports) {
                ...
                for (
                    var i = 0,
                        n = (e = ac_dom_nodes.isNodeList(e) ?
                            Array.prototype.slice.call(e) : [].concat(e)).length; i < n; i++
                )
            ...
            (proto.addElement = function(e, t) {
                var i = null;
                if (
                    (void 0 === t && (t = this.options.useRenderedPosition), !ac_dom_nodes.isElement(e))
                )
                    throw new TypeError(
    ...
    64: [
        ...
        { "./extend": 66, "@marcom/ac-polyfills/Array/isArray": 67 },
    ],
    65: [
        function(require, module, exports) {
            "use strict";
        ...
        function(require, module, exports) {
            !(function() {
                ...
                (window.AppMeasurement_Module_ActivityMap = function(e) {
                        ...
                        if (
                            (t.dataset && (c = t.dataset[n]) ?
                                ...
                                ((c = t.getAttribute("data-" + a)) ?
                                    (o = c) :
                                    (c = t.getAttribute(a)) && (o = c)), !o && e.useForcedLinkTracking && r)
                        ) {
                            var s;
                            if (
                                ...
                                for (
                                    c = !1; n < t.length && s && ((a = t.charAt(n)), c || a !== s);

                                )
                                    "\\" === a ? (c = !0) : ((varValue += a), (c = !1)), n++;
                            }
                            (s = varValue) && (e.w[i] = s);
                        }
                        return o || (r && e.w[i]);
                    ...
                    (c.region = function(e) {
                        for (
                            var t, n = c.regionIDAttribute || "id"; e && (e = e.parentNode);
                ...
                (window.AppMeasurement = function(e) {
                    ...
                    (t.Kb = function() {
                        ...
                        "number" == typeof e &&
                            10 > e &&
                            ((t.unsupportedBrowser = !0), t.xb(t, function() {}));
                    }),
                    (t.ya = function() {
                    ...
                    (t.zb = function(e) {
                        t.useLinkTrackSessionStorage ?
                            t.Ea() && n.sessionStorage.setItem(t.P, e) :
                            t.cookieWrite(t.P, e);
                    }),
                    (t.Sb = function() {
                        if (!t.bc) {
                    ...
                    (t.hc = function(e) {
                        var n, a, i, r;
                        for (n = 0; 2 > n; n++)
                            for (a = 0 < n ? t.Ga : t.g, i = 0; i < a.length; i++)
                                (e[(r = a[i])] = t[r]),
                                e[r] ||
                    ...
                    (t.cb = function(e) {
                        return (
                            t.maxDelay || (t.maxDelay = 250), !t.u("_d") ||
                            (e &&
                                setTimeout(function() {
                                    e();
                                }, t.maxDelay), !1)
                    ...
                    (t.ob = function() {
                        return (
                            t.ca || t.H || (t.eb(t.Cb) ? (t.H = !0) : (t.ca = !0)), !(t.ca && !t.H)
                        );
                    }),
                    (t.mb = function() {
                        var e = t.wa();
                    ...
                    (t.qb = function() {
                        ...
                        return (!e ||
                            ...
                            (t.Y &&
                                ((t.Y = !1),
                                    t.I || ((t.I = !0), e.getVisitorValues(t.Db))), !t.I)
                        );
                    }),
                    (t.T = function() {
                        var e = t.visitor;
                    ...
                    (t.tb = function() {
                        return (
                            t.aa || t.G || (t.cb(t.Aa) ? (t.G = !0) : (t.aa = !0)), !(t.aa && !t.G)
                        );
                    }),
                    (t.ba = !1),
                    (t.vb = function() {
                                ...
                                (t.abort ||
                                    (t.trackOffline &&
                                        ...
                                        ((e = t.Util.getQueryParam(
                                            ...
                                            (t.referrer =
                                                ...
                                                e :
                                                c.document.referrer)),
                                        (t.$a = 1), !t.referrer && t.Z && (t.referrer = t.Z),
                                        (t.Z = 0),
                                    ...
                                    (s &&
                                        ...
                                        (t.supplementalDataID = s.getSupplementalDataID(
                                            "AppMeasurement:" + t._in, !t.expectSupplementalData
                                        )),
                        ...
                        if ("object" == typeof e.dests)
                            for (var n = 0; n < e.dests.length; ++n) {
                                ...
                                if ("string" == typeof a.c && "aa." == a.id.substr(0, 3))
                                    for (
                                        var i = a.c.match(t.gc), r = 0; r < i.length;
                                        ++r
                                    ) {
                                        var o = i[r],
                                            c = o.match(t.Za),
                                ...
                                (t.nb(e) &&
                                    ...
                                    (t.bb() && ((r = 2), (i = new XMLHttpRequest())),
                                        ...
                                        ((t.AudienceManagement &&
                                                t.AudienceManagement.isReady()) ||
                                            0 != t.usePostbacks) &&
                                        (t.X ? (i.Ha = !0) : (i = 0))), !i && t.fc && (e = e.substring(0, 2047)), !i &&
                                    t.d.createElement &&
                                    (0 != t.usePostbacks ||
                                        (t.AudienceManagement &&
                                            t.AudienceManagement.isReady())) &&
                        ...
                        t.Ya = function() {
                            if (t.trackOffline)
                                for (
                                    ...
                                    (t.offlineLimit = 10); t.i.length > t.offlineLimit;
    ...
    75: [
        ...
        { "./AppMeasurement/initialize": 73, "./AppMeasurement/plugins": 74 },
    ],
    76: [
        function(require, module, exports) {
            "use strict";
        ...
        function(require, module, exports) {
            ...
            function isTablet() {
                var e = globalsHelper.getWindow(),
                    i = e.screen.width;
                return (
                    e.orientation && e.screen.height < i && (i = e.screen.height), !isDesktop() && i >= MIN_TABLET_WIDTH
                );
            }
    ...
    82: [
        ...
        { "./helpers/globals": 78, "@marcom/function-utils/once": 84 },
    ],
    83: [
        function(require, module, exports) {
            "use strict";
                    ...
                    return (
                        _createClass(e, [{
                                    ...
                                    if (
                                        ...
                                        if (
                                            (o ||
                                                ...
                                                this._setConfigurationProperty(
                                                    dlKeys.clickTimerLinkInteraction, !1
                                                ),
                                                this._setConfigurationProperty(
                            ...
                            },
                            {
                                ...
                                value: function(e, t) {
                                    for (
                                        var r = constants.countryBuckets.length, a = 2, o = 0; o < r; o++
                                    )
    ...
    92: [
        function(require, module, exports) {
            ...
            (proto._assembleActivityMapCollection = function() {
                ...
                for (
                    var e = document.querySelectorAll("a, button"), t = [], i = 0; i < e.length; i++
                ) {
            ...
            (proto._determineRegionName = function(e, t, i) {
                ...
                return (
                    a || ((a = document.body), (n = "body")), { el: a, id: n.toLowerCase() }
                );
            }),
    ...
    94: [
            ...
            module.exports = function(e) {
                e.ActivityMap.link = function(t, i) {
                    ...
                    if (
                        ...
                        return (n = r(t)) ?
                            -1 !== n.linkId.indexOf("/shop/goto/bag") ?
                            "true" === n.element.getAttribute("aria-expanded") ?
                            n.linkId + initialBagState :
                            n.linkId + alteredBagState :
                            n.linkId :
        ...
        { "./ActivityMapCollection": 92, "@marcom/useragent-detect": 88 },
    ],
    95: [
        function(require, module, exports) {
            "use strict";
    ...
    96: [
                            ...
                            init: function() {
                                s &&
                                    ...
                                    (s.ac_amt.addListener(
                                            ...
                                            window,
                                            "scroll",
                                            s.ppv.throttle(s.ppv.scroll, s.ppv.throttleAmount), !1
                                        ),
                                        s.ac_amt.addListener(
                                            "ppv_resize",
                                            window,
        ...
        { "../../constants": 140, "../../helpers/isStorageAvailable": 155 },
    ],
    97: [
        function(require, module, exports) {
            "use strict";
            ...
            module.exports = function(t) {
                ...
                (t.linkHandler = function(t, e, n) {
                    var r,
                        ...
                        u = s;
                    return (
                        (e = e || "o"), !u || (o.linkType && (u || o.linkName)) ?
                        "" :
                        ((r = u.indexOf("?")),
                            (u =
                                o.linkLeaveQueryString || r < 0 ? u : u.substring(0, r)),
                            (i = o.pt(t, "|", "p_gn", u.toLowerCase())) ?
                            ((o.linkName = "[[" == i ? "" : i),
                                (o.linkType = e),
                                n ? s : u) :
                            "")
                    ...
                    if (
                        ...
                        for (var f in ((a = e.split(",")),
                            ...
                            if (a.hasOwnProperty(f))
                                for (var l in (a[f].indexOf("contextData") > -1 &&
                                        ((lax = a[f].split("'")), (a[f] = "contextData." + lax[1])),
                                        i))
                                    a[f] == i[l] && (i[l] = "");
        ...
        function(require, module, exports) {
            ...
            doPluginsRegistry.pretracking.main.steps.push(
                ...
                doPluginsRegistry.tracking.main.steps.push(
                    ...
                    require("./plugins/targetResponse"),
    ...
    121: [
        ...
        { "../helpers": 103, "@apple/analytics-bp-passive-tracker-loader": 2 },
    ],
    122: [
        function(require, module, exports) {
            "use strict";
    ...
    136: [
        ...
        { "../../ErrorHandler": 137, "../../helpers/DOM": 142 },
    ],
    137: [
        function(require, module, exports) {
            "use strict";
                                ...
                                if (
                                    ...
                                    if (
                                        ("page" === e.type ?
                                            ...
                                            trackerRegistry.processBeaconByType(e.type, e), !isEmptyObj(e.beacon))
                                    ) {
                                        ...
                                        return e.options.deferred ?
                                            ...
                                            void(!0 !== e.options.silent &&
                                                (this._queue.add(e), !0 !== this.paused ?
                                                    this._run() :
                                                    this._queue.collect())
                                            );
                                    }
    ...
    141: [
        ...
        { "./Tracker": 139, "./trackers/regions/regions": 189 },
    ],
    142: [
        function(require, module, exports) {
            "use strict";
            ...
            function isIntraPageLink(e) {
                var t;
                return (!domNodes.isNodeType(e, domNodes.NODE_TYPES.ELEMENT) ||
                    !e.href ||
    ...
    144: [
        function(require, module, exports) {
            ...
            function refresh(e) {
                ...
                for (
                    var k = {}, y = document.querySelectorAll(r), b = 0; b < y.length; b++
                ) {
    ...
    149: [
        ...
        { "../ErrorHandler": 137, "./separator": 160 },
    ],
    150: [
        function(require, module, exports) {
            "use strict";
        ...
        { "../constants": 140, "@apple/analytics-data-layer": 4 },
    ],
    151: [
        function(require, module, exports) {
            "use strict";
    ...
    165: [
        ...
        { "../../ErrorHandler": 137, "../../constants": 140, "./Registry": 164 },
    ],
    166: [
        function(require, module, exports) {
            "use strict";
            ...
            var PageObserver = require("./observers/Page"),
                ...
                isNode = require("@marcom/ac-dom-nodes").isNode,
                defaults = {
                    onDOMContentLoadedOptions: { section: { autoEnable: !1 } },
            ...
            function onDOMContentLoaded(e) {
                var t = { section: new SectionObserver(e.section) };
                return (
                ...
                ClickAnalyticsObserver = (function(e) {
                    ...
                    function r() {
                        ...
                        return (
                            ...
                            (e._elements = null), !0 === e.options.autoEnable && e.enable(),
                            e
                        );
                    }
                    return (
    ...
    168: [
        ...
        { "../ErrorHandler": 137, "../Tracker": 139, "./observerRegistry": 174 },
    ],
    169: [
        function(require, module, exports) {
            "use strict";
                ...
                LinkAnalyticsObserver = (function(e) {
                    ...
                    function r() {
                        ...
                        return (
                            ...
                            (e.tracker = Tracker),
                            (e.isEnabled = !1),
                            (e.defaultTracking = e.track.bind(_assertThisInitialized(e))), !0 === e.options.autoEnable && e.enable(),
                            e
                        );
                    }
                    return (
                    ...
                    function r() {
                        ...
                        return (
                            ...
                            (e.onPageHide = e.track.bind(
                                _assertThisInitialized(e),
                                "pageHide", { deferred: !0, beacon: {} }
                            )),
                            (e.onScroll = e.onScroll.bind(_assertThisInitialized(e))), !0 === e.options.autoEnable && e.enable(),
                            e
                        );
                    }
                    return (
                ...
                SectionAnalyticsObserver = (function(e) {
                    ...
                    function n() {
                        ...
                        return (
                            ...
                            (e.isEnabled = !1),
                            (e.sections = []),
                            (e._listeners = !1), !0 === e.options.autoEnable && e.enable(),
                            e
                        );
                    }
                    return (
                ...
                VideoAnalyticsObserver = (function() {
                    function e(t) {
                        ...
                        _classCallCheck(this, e),
                            ...
                            observerRegistry.add(this), !0 === this.options.streamingVideo &&
                    ...
                    return (
                        _createClass(e, [{
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    var t = this._bundleTrackingData(
                                        this._events.texttrackshow,
                                        e
                                    );
            ...
            function track(e, t) {
                if (
                    ...
                    t.overwriteAppMeasurementValues &&
                        (e.options.overwriteAppMeasurementValues = !0), !1 === t.overwriteAppMeasurementEvents &&
                ...
                return (
                    _createClass(e, [{
                            ...
                            value: function(e, r, i, n) {
                                this.registry[r] = { type: e, name: r, order: i, track: n };
                            },
                        },
                        {
            ...
            function track(e) {
                ...
                return (
                    ...
                    (e.beacon.prop3 = e.beacon.title =
                        formatter.eventString(a, "") + r + e.data.incoming.id), !0 === e.data.galleryFirstTimeTrigger &&
    ...
    184: [
        ...
        { "./TrackerRegistry": 176, "./pageHide": 185 },
    ],
    185: [
        function(require, module, exports) {
            "use strict";
            ...
            function track(e) {
                return (
                    ...
                    setProperty(
                        e.beacon,
                        "prop19",
                        e.beacon.prop20 + separator.colon + e.beacon.pageName
                    ),
                    ...
                    return (
                        _createClass(t, [{
                                ...
                                value: function() {
                                    var t = "";
                                    return (
                                        this.options.name && (t = this.options.name), !this.options.name &&
                                        this.element.id &&
    ...
    189: [
        function(require, module, exports) {
            ...
            function getAllRegions() {
                ...
                function i(e) {
                    for (
                        var o; domNodes.isNodeType(n[t + 1], domNodes.NODE_TYPES.ELEMENT) &&
        ...
        { "./Region": 188, "@marcom/ac-dom-nodes": 22 },
    ],
    190: [
        function(require, module, exports) {
            "use strict";
            var getBeginBeacon = require("@apple/analytics-search").begin,
                ...
                config = {
                    action: { OPEN: "open", ENGAGE: "engage" },
            ...
            function getSearchObj(e) {
                ...
                var a = e.event.dynamicEventBinderTarget,
                    r =
                    get(pageTypeKey) === config.errorPage.pageType &&
                    a.id === config.errorPage.id,
                    n = config.globalNavMobile === a.id;
                return r || n ? { action: config.action.ENGAGE } :
                    config.globalNav === a.id ? { action: config.action.OPEN } :
                    null;
            }
            module.exports = { track: track, initialize: initialize };
        },
    ...
    "@marcom/ac-analytics": [
        function(require, module, exports) {
            ...
            module.exports = {
                ...
                resetActivityMap: require("./ac-analytics/Appmeasurement/appMeasurementPlugins/activitymap/ActivityMapCollection")
                    .createActivityMapCollection,
                addActivityMapItem: require("./ac-analytics/Appmeasurement/appMeasurementPlugins/activitymap/ActivityMapCollection")
                    .addElToCollection,
                errorHandler: require("./ac-analytics/ErrorHandler"),
                trackFirstMeaningfulPaint: require("./ac-analytics/trackers/performance")
