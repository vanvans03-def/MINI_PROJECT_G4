...
function _iterableToArrayLimit(e, t) {
    var r = [],
        ...
        i = !1,
        o = void 0;
    try { for (var n, s = e[Symbol.iterator](); !(a = (n = s.next()).done) && (r.push(n.value), !t || r.length !== t); a = !0); } catch (e) { i = !0, o = e } finally { try { a || null == s.return || s.return() } finally { if (i) throw o } }
    return r
}
...
require = function() {
    return function e(t, r, a) {
        function i(n, s) {
            if (!r[n]) {
                if (!t[n]) { var l = "function" == typeof require && require; if (!s && l) return l(n, !0); if (o) return o(n, !0); var c = new Error("Cannot find module '" + n + "'"); throw c.code = "MODULE_NOT_FOUND", c }
                var u = r[n] = { exports: {} };
                t[n][0].call(u.exports, function(e) { return i(t[n][1][e] || e) }, u, u.exports, e, t, r, a)
            }
            return r[n].exports
        }
    ...
    1: [function(e, t, r) {
        var a = !1,
            i = window || self;
        try { a = !!i.localStorage.getItem("f7c9180f-5c45-47b4-8de4-428015f096c0") } catch (e) {}
        t.exports = a
    }, {}],
    2: [function(e, t, r) {
        var a = e("../enabled");
        t.exports = function(e) { return function() { if (a && "object" === _typeof(window.console) && "function" == typeof console[e]) return console[e].apply(console, Array.prototype.slice.call(arguments, 0)) } }
    }, { "../enabled": 1 }],
    3: [function(e, t, r) { t.exports = e("./internal/expose")("log") }, { "./internal/expose": 2 }],
    "@marcom/data-relay": [function(e, t, r) {
        var a, i = e("@marcom/ac-console/log");
        try { a = e("@marcom/ac-analytics") } catch (e) { i(e) }
        var o = { properties: { absoluteUrlRegex: new RegExp("^(?:[a-z]+:)+//", "i"), analyticsTitle: "data relayed", cidQueryParam: "cid", cookieDomain: ".apple.com", cookieMaxKeyLength: 5, cookieName: "aw_rid", cookieValueSeparator: "|", cookieValueEntrySeparator: ":", customAnalyticsAttribute: "", dataMaxLength: 100, deferNavigationTimeout: 400, interactionEvent: "mouseup", internalLinkAttribute: "data-analytics-intrapage-link", parseRelativeUrlRegex: new RegExp("^([./]*)(.+)"), prefixAllowedCharacters: /^[A-Za-z0-9_]+$/, prefixMaxLength: 3, relayButtonUrlAttribute: "data-url", ridQueryParam: "rid", ridRelayAttribute: "data-rid-relay", ridRelaySelector: "[data-rid-relay]", ridStoreAttribute: "data-rid-store", ridStoreSelector: "[data-rid-store]", ridPrefixSeparator: "-", trackingDataSeparator: "|", trackingProperty: "eVar17", urlFormatHostName: "https://apple.com/", urlSeparator: ",", valueAllowedCharacters: /^[A-Za-z0-9-_%]+$/ }, options: { automaticMode: !0, canDeferNavigation: !0, trackCid: !1, useJsonStorageFormat: !1, useSecureCookie: !0 }, passiveTracking: { overwriteStorageItem: !1, overwriteStorageItemValues: !0, overwriteAppMeasurementValues: !0, overwriteAppMeasurementEvents: !0 } },
            n = function() {
                function e(t) { _classCallCheck(this, e), this._isSupported() && this._initialize(t) }
                return _createClass(e, [{ key: "_isSupported", value: function() { if (!(window && document && document.documentElement && Array.prototype.includes)) return !1; try { var e = new window.URL("x", "http://w"); return e.pathname = "y%20z", "http://w/y%20z" === e.href && void 0 !== e.searchParams } catch (e) { return !1 } } }, {
                    key: "_initialize",
                    value: function(e) {
                    ...
                    value: function(e) {
                        ...
                        if (e) {
                            var r = Object.keys(o);
                            Object.keys(e).forEach(function(a) { r.includes(a) && (t[a] = Object.assign(t[a], e[a])) })
                        }
                    }
                }, { key: "_setupEventHandlers", value: function() { this._handleClick = this._handleClick.bind(this), document.documentElement.addEventListener(this.properties.interactionEvent, this._handleClick) } }, {
                    key: "_handleClick",
                    value: function(e) {
                    ...
                    value: function(e) {
                        ...
                        if (i <= 0) return r;
                        for (var o = Object.keys(e), n = a.filter(function(e) { return !o.includes(e) }); i > 0;) {
                            var s = void 0;
                            s = n.length ? n : o, delete r[this._getRandomArrayItem(s)], i--
                        }
                        return r
                    }
                }, { key: "writeCookieFromObj", value: function(e) { var t = ""; return this.options.useSecureCookie && (t = " secure;"), !this.options.trackCid && e.cid && delete e.cid, this._deleteInvalidValues(e), !this._isEmpty(e) && (!!(e = this._formatCookieData(e)) && (document.cookie = "".concat(this.properties.cookieName, "=").concat(e, "; path=/; domain=").concat(this.properties.cookieDomain, ";").concat(t), e)) } }, { key: "_formatCookieData", value: function(e) { return e ? this.options.useJsonStorageFormat ? encodeURIComponent(JSON.stringify(e)) : this._createSimpleFormatCookieData(e) : null } }, {
                    key: "_createSimpleFormatCookieData",
                    value: function(e) {
                        var t = this,
                            r = "";
                        return Object.keys(e).forEach(function(a) { r += "".concat(a).concat(t.properties.cookieValueEntrySeparator).concat(encodeURIComponent(e[a])).concat(t.properties.cookieValueSeparator) }), r = r.substring(0, r.length - this.properties.cookieValueSeparator.length), encodeURIComponent(r)
                    }
                }, {
                    key: "_handleRidRelay",
                    value: function(e, t) {
                    ...
                    value: function(e, t, r, a) {
                        if (i("Data Relay - analytics tracking - " + this.properties.trackingProperty + ' should be tracked with the value "', t + '"'), this.analytics) {
                            ...
                            this.options.canDeferNavigation && "A" === e.tagName && !this._isIntraPageLink(e) && (a.preventDefault(), this.timeout = setTimeout(function() { window.location = e.href }, this.properties.deferNavigationTimeout)), this.analytics.track(o)
                        }
                    }
                }, {
                    ...
                    value: function(e, t, r) {
                        ...
                        var i = this._buildEventsString(r, a),
                            o = { title: a.analyticsTitle || this.properties.analyticsTitle, events: i };
                        return o[a.trackingProperty || this.properties.trackingProperty] = t, o
                    }
                }, { key: "_buildEventsString", value: function(e, t) { var r = ""; return Object.keys(e).forEach(function(e) { t && t.eventTracking && t.eventTracking[e] ? r += "event".concat(t.eventTracking[e], ",") : "cid" !== e && (r += "event".concat(e, ",")) }), r = r.substring(0, r.length - 1) } }, {
                    ...
                    value: function(e, t) {
                        ...
                        return n.forEach(function(e) {
                            ...
                            if ("string" == typeof t[e] && (t[e] = [t[e]]), t[e].forEach(function(e) {
                                ...
                                var n = new Set(r);
                                Array.from(n).forEach(function(e) { o.push(e) })
                            }
                        ...
                        return o.forEach(function(o) {
                            ...
                            s.forEach(function(s) {
                                if (s + "" in r) {
                                    ...
                                    "string" == typeof t[s] && (t[s] = [t[s]]), t[s].forEach(function(e) { c.searchParams.set(e, r[s]) });
                                    var u = c.toString();
                    ...
                    value: function() {
                        var e = this,
                            t = document.cookie,
                            r = (t = t.split("; ")).find(function(t) { return 0 === t.indexOf(e.properties.cookieName) });
                        return r ? (r = this._readCookie(r.split("=")[1]), this._deleteInvalidValues(r), !this._isEmpty(r) && r) : null
                    }
                }, { key: "_readCookie", value: function(e) { return e ? this.options.useJsonStorageFormat ? JSON.parse(decodeURIComponent(e)) : this._readSimpleFormatCookie(e) : {} } }, {
                    ...
                    value: function(e, t, r, a) {
                        ...
                        var l = _defineProperty({ events: s = this._listToString(s) }, this.properties.trackingProperty, n);
                        return this.analytics && r && t && l[this.properties.trackingProperty] && l.events && (a ? this.analytics.passiveTracker(l, this.passiveTracking) : (l.title = this.properties.analyticsTitle, this.analytics.track(l))), { data: n, trackingData: l }
                    }
                }, { key: "get", value: function(e) { var t = this.getRidFromCookie(); return t && void 0 !== t[e] ? t[e] : null } }, { key: "set", value: function(e, t) { return e && "string" == typeof e && t && "string" == typeof t ? this.storeRid(_defineProperty({}, e, t)) : null } }, { key: "_listToString", value: function(e) { var t = ""; return e.forEach(function(e) { t += "".concat(e, ",") }), t.substring(0, t.length - 1) } }, {
                    key: "getQueryString",
                    value: function(e) {
                        var t = {};
                ...
                }, { key: "_isEmpty", value: function(e) { return 0 === Object.keys(e).length } }, {
                    key: "_parseRidStringData",
                    value: function(e) {
                        var t, r = this;
                        try { t = decodeURIComponent(e) } catch (e) { i(e) }
                        if (!t) return {};
                        var a = {};
                ...
                }, { key: "_formatUrl", value: function(e) { var t = { relative: !1, original: !1, url: null }; if (this.properties.absoluteUrlRegex.test(e)) return t.url = e, t; var r = this.properties.parseRelativeUrlRegex.exec(e); return r.length && r[r.length - 1] ? (t.relative = !0, t.original = r[1], t.url = this.properties.urlFormatHostName + r[r.length - 1], t) : null } }, { key: "_parseCidStringData", value: function(e) { var t = {}; return t[this.properties.cidQueryParam] = e, t } }, {
                    key: "_ancestor",
                    value: function(e, t) {
                        if (e.matches(t)) return e;
                        for (;
                            (e = e.parentNode) && e.nodeType === Node.ELEMENT_NODE;) { if (!t || e.matches(t)) return e; if (e === document.documentElement) break }
                        return null
                    }
                }, { key: "_getRandomArrayItem", value: function(e) { return e.splice(Math.floor(Math.random() * e.length), 1) } }, { key: "_isIntraPageLink", value: function(e) { var t = e.getAttribute("href"); return !(null !== t && "#" !== t.charAt(0) && 0 !== t.indexOf("javascript:") && 0 !== t.indexOf("mailto:") && 0 !== t.indexOf("tel:") && !e.hasAttribute(this.properties.internalLinkAttribute)) } }]), e
            }();
        t.exports = n
