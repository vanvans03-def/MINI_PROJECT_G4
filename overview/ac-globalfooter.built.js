!(function t(e, i, n) {
    ...
    for (
        var s = "function" == typeof require && require, o = 0; o < n.length; o++
    )
        r(n[o]);
    return r;
})({
    ...
    14: [
                ...
                f = (function(t) {
                    ...
                    return (
                        (0, s.default)(i, [{
                                ...
                                value: function() {
                                    var t = this;
                                    ((this._buystrip = this.el.querySelector(
                                            "".concat(this._selectors.wrapper, "-buystrip")
                                        )),
                                        this._buystrip) &&
                                    (this._buystrip
                                        .querySelectorAll(
                                            "".concat(
                                                this._selectors.wrapper,
                            ...
                            },
                            {
                                ...
                                value: function(t) {
                                    ...
                                    if (e) {
                                        ...
                                        (i.href = e.href),
                                        "analyticsTitle" in e.dataset &&
                                            (i.dataset.analyticsTitle = e.dataset.analyticsTitle),
                                            "analyticsExitLink" in e.dataset &&
                                            (i.dataset.analyticsExitLink =
                                                e.dataset.analyticsExitLink);
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    if (
                                        ((this._chatLink = this._buystrip.querySelector(
                                                "".concat(
                                                    this._selectors.wrapper,
                                                    "-buystrip-info-cta-chat"
                                                )
                                            )),
                                            this._chatLink)
                                    ) {
                                        ...
                                        t.href && (this._chatLink = t),
                                            (this._onChatLinkClick =
                                                this._onChatLinkClick.bind(this)),
                                            this._chatLink.addEventListener(
                                                "click",
                                                this._onChatLinkClick
                                            );
                                    }
        ...
        { 1: 1, 10: 10, 3: 3, 5: 5, 6: 6, 7: 7, 8: 8, 9: 9 },
    ],
}, {}, [13]);